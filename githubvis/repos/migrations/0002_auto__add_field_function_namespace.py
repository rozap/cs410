...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Function.namespace'
        db.add_column(u'repos_function', 'namespace',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2047),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Function.namespace'
        db.delete_column(u'repos_function', 'namespace')
    ...
    models = {
        ...
        u'repos.function': {
            ...
            'namespace': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2047'})
        },
        u'repos.repo': {
