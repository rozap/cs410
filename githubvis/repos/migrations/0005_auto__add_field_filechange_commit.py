...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileChange.commit'
        db.add_column(u'repos_filechange', 'commit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['repos.Commit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileChange.commit'
        db.delete_column(u'repos_filechange', 'commit_id')
