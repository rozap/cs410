...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Function.name'
        db.alter_column(u'repos_function', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Function.name'
        db.alter_column(u'repos_function', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
