...
public class Call extends Node {
    ...
    public Node getCallingFunction() {
        Node currentNode = this.parent;
        while(currentNode != null) {
            if(currentNode instanceof FunctionDef) {
                return currentNode;
            }
...
//            System.out.println();
        ...
        if (call != null) {
            ...
            FunctionDef caller = (FunctionDef)((Call)call).getCallingFunction();
            //func.func is the callee
            if(caller != null) {
                Indexer.idx.addFunctionCall(caller, func.func);
            } else {
                System.out.println("Caller for " + func.func + " is null");
            }
    ...
    public String toString() {
        return "    Call to: " + func.toString() + ":" + args + ":" + start;
    }
